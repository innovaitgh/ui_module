...
var _with_resource = require("./with_resource");
...
var MyList = function MyList(props) {
  ...
  }))), activity ? _react["default"].createElement(_with_resource.Activity, null) : _react["default"].createElement(_core.List, null, data.map(function (item, i) {
